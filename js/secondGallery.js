...
if(gImages){
    gImages.forEach(function(imgg, index){
        imgg.onclick = function(){
            ...
            let getIurlPos = getFImgURL.split("/Blatchford/Pictures/");
            ...
            nImg.setAttribute("src", "/Blatchford/Pictures/" + setNImgURL);
            nImg.setAttribute("id", "curr-img");

            nImg.onload = function() {
                let imgWidth = this.width;
                let calcImageToEdge = ((winwidth - imgWidth) / 2) - 80;
                ...
                newNBtn.style.cssText = "right: " + calcImageToEdge + "px;";
                ...
                newPBtn.style.cssText = "left: " + calcImageToEdge + "px;";
            }
...
function changeImage(changeDirectory){
    ...
    nImg.setAttribute("src", "/Blatchford/Pictures/Interior" + calNewImage +".jpg");
    nImg.setAttribute("id", "curr-img");
